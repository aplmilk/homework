...
class SnakeGame:
    ...
    def __init__(self):
        ...
        r=random.randrange(101,200,self.step)
        ...
        self.frame1=Frame(window,width=600,height=370)
        self.frame2=Frame(window,width=600,height=30)
        self.canvas=Canvas(self.frame1,width=600,height=370,bg='yellow')
        self.score_label=Label(self.frame2,width=600,height=30,text='Score:',anchor=W)
    ...
    def draw_wall(self):
        ...
        self.canvas.create_line(8,8,8,362,fill='blue',width=5)
        self.canvas.create_line(584,8,584,362,fill='blue',width=5)
        
    def draw_score(self):
        self.score()                        # score model
        self.score_label.config(self.score_label,text="Score: "+str(self.gamescore)+"    Level:"+str(int(self.gamescore/100)+1)+"    Length:"+str(int(self.gamescore/10)+3))
    ...
    def play(self):
        ...
        while True:
            if self.isdead():
                ...
                self.draw_snake() 
                self.canvas.after(200-int((self.gamescore/100)*10))
                self.canvas.update()
